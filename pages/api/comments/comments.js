...
export default async function asynchandler(req, res) {
  ...
  if (isBelongs) {
    query = gql`
      mutation CreateComment($name: String!, $email: String!, $comment: String!, $isBelongs: Boolean, $id: ID!) {
        createComment(
          data: {
            name: $name
            email: $email
    ...
    query = gql`
      mutation CreateComment($name: String!, $email: String!, $comment: String!, $isBelongs: Boolean, $slug: String!) {
        createComment(
          data: {
            name: $name
            email: $email
