...
const TeamPage = ({post, ep,slugs}) => {
 ...
 var title_ = post.title;
    ...
    //     delay: 100,
    //     smooth: true,
    //     offset: 370, // Scrolls to element + 50 pixels down the page
      ...
      <Head>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12" >
          ...
          <PageDetail post ={post} type={"sad"}  ep ={ep} />
            ...
            <CommentsFrom Slug={`/post/${post.slug}`} slug={post.slug} type="page" selected={selected}  Setselected={Setselected}/>
            <Comments slug={post.slug} from="pages" selected={selected}  Setselected={Setselected}  Author ={post.author}/>
          </div>
