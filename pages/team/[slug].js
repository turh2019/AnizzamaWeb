...
const TeamPage = ({post, ep,slugs}) => {
 ...
 if( post.linkVideo.length >0)
  ...
  if( post.summary.length >0)
    ...
    var typee;
           if(slugs.slug === 'jobs') {
             descriptionA = "אניזאמה; אנימות לצפייה ישירה עם כתוביות בעברית!\Nעמוד הדרושים; בעמוד זה תוכלו להבחן ולראות את מגוון התפקידים בפאנסאב.\Nבין אם זה מתרגם, עורך לשוני, מקרייק וכו'. כמו כן, תמיד אפשר ללמוד משהו חדש!"
             descriptionB = "אניזאמה; אנימות לצפייה ישירה עם כתוביות בעברית!\Nעמוד הדרושים; בעמוד זה תוכלו להבחן ולראות את מגוון התפקידים בפאנסאב.\Nבין אם זה מתרגם, עורך לשוני, מקרייק וכו'. כמו כן, תמיד אפשר ללמוד משהו חדש!"
             titleA = "Anizzama - Jobs"
             dd = "jobs"
             typee = "Jobs Page"

            } else if(slugs.slug === 'about') {
             descriptionA = "אניזאמה; אנימות לצפייה ישירה עם כתוביות בעברית!\Nעמוד האודות; בעמוד זה תוכלו לקרוא כל מה שאתם צריכים לדעת עלינו!\Nמקווה שתהנו מהסיפור שלנו! כמו כן, יתכם ובהמשך נוסיף עוד פרטים."
             descriptionB = "אניזאמה; אנימות לצפייה ישירה עם כתוביות בעברית!\Nעמוד האודות; בעמוד זה תוכלו לקרוא כל מה שאתם צריכים לדעת עלינו!\Nמקווה שתהנו מהסיפור שלנו! כמו כן, יתכם ובהמשך נוסיף עוד פרטים."
