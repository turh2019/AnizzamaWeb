...
import { AdjacentPostCard } from '../components/getComponents';
      ...
      {dataLoaded && (
        <>
          ...
          {adjacentPost.previous && (
            <div className={`${adjacentPost.next ? 'col-span-1 lg:col-span-1' : 'col-span-1 lg:col-span-8'} adjacent-post rounded-lg relative h-72 `}>
