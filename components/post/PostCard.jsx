...
const PostCard = ({ post }) => (
  <div className="bg-cover_bg_color text-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8 border-2  border-[#18154E] rtl:mr-3 " dir="rtl">
    ...
    <div className="block lg:flex text-center items-center  mb-8 w-full text-white ">
      ...
      <div className="font-medium text-white-700">
        ...
        <span className="align-middle">{moment(post.createdAt).format('MMM DD, YYYY')}</span>
          ...
          <h1 className="transition duration-700 text-center color-white  mb-8 cursor-pointer hover:text-cover_color text-3xl font-semibold  ">
