                    ...
                    }).map((val,key)=>
                    {
                        itsfound ="true";
                            ...
                            <div className='flex   mb-2 text-white  mb-4 text-white px-4  '>
                                     ...
                                     <Link target="_blank" key={key} href={`/${val.node.format}/${val.node.slug}`} ><p className=' flex-grow w-20 flex justify-center text-center transition duration-700 text-center color-white   hover:text-[#4864F6]   ' >{val.node.title}</p></Link>
