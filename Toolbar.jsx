    ...
    return (
        ...
        <div className=' bg-contain bg-center bg-no-repeat  pb-3 bg-clip-padding  p-6 grid grid-cols-1 gap-4  place-items-center '>
            <div className='place-self-end flex flex-wrap'>      
                <div className='place-self-canter  px-3 pb-3 my-2 gap-5'>
                    {pages.map((page)=>(
                        ...
                        <a target="_blank" key="home" href={`/`} className=' '>
                         <Link target="_blank" key="home" href={`/`}>
                            <span className='transition duration-500 ease hover:bg-[#382C8B] inline-block bg-[#4864F6] text-lg font-medium rounded-full text-white px-8  cursor-pointer lg:mt-0 mt-4 mx-2 ' onClick={e=>Setselected("")}>
                                    בית
                            </span>
                        </Link>
                        </a>
